...
LIB3DM_OBJ    = contrib/lib3dm/opennurbs_crc.o contrib/lib3dm/3dm.o
...
lib3dm:
	make -C contrib/lib3dm

contrib: bzip2 giflib packjpg packmp3 zlib liblzma lib3dm

$(PROGNAME): contrib
	c++ $(CFLAGS) $(GIFLIB_OBJ) $(PACKJPG_OBJ) $(PACKMP3_OBJ) $(BZIP2_OBJ) $(ZLIB_OBJ) $(LIBLZMA_OBJ) $(LIBLZMA_CPP) $(LIB3DM_OBJ) precomp.cpp -s -oprecomp
